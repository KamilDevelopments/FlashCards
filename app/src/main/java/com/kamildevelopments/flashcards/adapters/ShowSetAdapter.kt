...
class ShowSetAdapter(private val sets: List<Flashcard>) :
    RecyclerView.Adapter<ShowSetAdapter.ShowSetViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ShowSetViewHolder {
        val itemView =
            LayoutInflater.from(parent.context).inflate(R.layout.item_show_set, parent, false)
